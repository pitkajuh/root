...
def to_bytes(s):
    """Return the parameter as type 'bytes'."""
...
def to_string(b):
    ...
    # There is no 'unicode' type in Python3 (all the Python3 cases were already
    # handled). In order to get a 'str' object, we need to encode the 'unicode'
    # object.
...
def to_unicode(s):
    ...
    In Python3, this is the string type.
